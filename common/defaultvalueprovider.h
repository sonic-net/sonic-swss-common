...
public:
    ...
    void AppendDefaultValues(const std::string &row, FieldValueMapping& sourceValues, FieldValueMapping& targetValues);
...
public:
    ...
    void AppendDefaultValues(const std::string &table, const std::string &row, FieldValueMapping& values);

    void AppendDefaultValues(const std::string &table, const std::string &row, std::vector<std::pair<std::string, std::string> > &values);

    std::shared_ptr<std::string> GetDefaultValue(const std::string &table, const std::string &row, std::string field);
