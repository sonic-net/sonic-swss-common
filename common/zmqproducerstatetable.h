...
{
public:
 ZmqProducerStateTable(DBConnector* db, const std::string& tableName,
                       ZmqClient& zmqClient, bool dbPersistence = false);
 ZmqProducerStateTable(RedisPipeline* pipeline, const std::string& tableName,
                       ZmqClient& zmqClient, bool buffered = false,
                       bool dbPersistence = false);
 ...
 virtual bool wait(std::string& dbName, std::string& tableName,
