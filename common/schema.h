...
#define APP_BUFFER_PORT_CONFIG_TO_PG_PROFILE_TABLE  "BUFFER_PORT_CONFIG_TO_PG_PROFILE_TABLE"
#define APP_BUFFER_PORT_CABLE_LENGTH_TABLE          "BUFFER_PORT_CABLE_LENGTH_TABLE"
